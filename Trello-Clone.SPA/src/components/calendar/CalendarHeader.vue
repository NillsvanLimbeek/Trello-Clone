        ...
        <div class="calendar-header__left">
            <div
                ...
                <IconBase
                    ...
                    <IconWeek :class="{ 'icon-active': calendarView === CalendarView.Week }" />
                </IconBase>
            ...
            <div
                ...
                <IconBase
                    ...
                    <IconMonth :class="{ 'icon-active': calendarView === CalendarView.Month }"/>
                </IconBase>
...
<script lang="ts">
    ...
    import { IconBase, IconWeek, IconMonth, IconArrow } from '@components/icons';
